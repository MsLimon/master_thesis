...
% 
% Test different numbers of misalignment points. Parameter space
...
try
    ...
    logfile = 'logfile_num_points.txt';
    reuse_geometry = true;
    ...
    % set the values of number of misalignment points to be tested
    values = [90,60,30];
    ...
    for j = 1:numValues
        ...
        misFilename = sprintf('misalignment_points_%d.txt',nMisPoints);
        % set the name of the struct containing the results
        outstruct_name = sprintf('%d_num_points_results.mat',nMisPoints);
