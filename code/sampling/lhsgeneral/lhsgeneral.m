...
for i=1:l
    prob=x(:,i);
    independent_samples(:,i) = icdf('norm',prob,0,1);                         % map latin hypercube samples to values using inverse cumulative distribution functions
end
...
Q=chol(R).';                                                                % Cholesky decomposition of the actual correlation matrix
