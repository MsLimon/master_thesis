function [P,Iline_data] = lensmodelair_mis(beta,taperx,yin,D0,w,M)
...
% is calculated at the outputfacet
    ...
    if isunix == 1
        ...
        modelpath = '';
        infile = '5parameters_model_sweep_with_air_655.mph'; % TODO - change file
    else
        modelpath = '../';
        infile = '5parameters_model_sweep_with_air.mph';
